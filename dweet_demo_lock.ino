/*
  ...
  This example is identical to dweet_demo, except that
  it is using a Dweet lock.

  As a result, the query must include the access key, and
  the dashboard.io account must be udjusted accordingaly.
...
char ssid[]       = "your_network_id";           //  your network SSID (name)
char pass[]       = "your_wifi_password";        // your network password (use for WPA, or use as key for WEP)

char dweet_key[]  = "2sR2sR2sR2sR2sR2sR2sR2sR";  // This is the Dweet Master key (read/write)
char thing[]      = "your_dweet_thing_name";     // The Dweet thing name, must be unique
